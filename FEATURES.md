...
## Grounded answers (`src/server.js` + system prompt)
Claude receives your full knowledge base with every question and is instructed to answer only from it, and to offer a human agent when the knowledge base doesn't cover the question. Prevents confident wrong answers.
